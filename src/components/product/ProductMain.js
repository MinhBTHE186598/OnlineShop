            ...
            <Container fluid style={containerStyle}>
                <Row>
                    ...
                    <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <div>
                            <h1 style={{ marginBottom: '50px' }}>{product.ProductName}</h1>
                            ...
                            <a href={`/profile/${sellerList.find(seller => seller.SellerID === product.SellerID).UserID}`} style={{ fontSize: 'x-large' }}>Người bán: {sellerList.find(seller => seller.SellerID === product.SellerID).SellerName}</a>
